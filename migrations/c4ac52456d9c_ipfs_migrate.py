...
def upgrade():
    op.create_table('userreport',
        ...
        sa.Column('type', postgresql.ENUM(
            'illegal_content', 'harrasment', 'spam', 'tos_violation', name='userreporttype'), nullable=True),
        sa.ForeignKeyConstraint(['author_id'], ['user.id'], name=op.f('fk_userreport_author_id_user')),
        sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_userreport_user_id_user')),
...
def downgrade():
    op.add_column('media', sa.Column('url', sa.VARCHAR(), autoincrement=False, nullable=True))
    ...
    op.create_table('user_report',
        ...
        sa.Column('type', postgresql.ENUM('ipg_violation', 'conduct_violation', 'dmca', name='reporttype'),
                  autoincrement=False, nullable=True),
        sa.ForeignKeyConstraint(['author_id'], ['user.id'], name='fk_user_report_author_id_user', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_user_report_user_id_user', ondelete='CASCADE'),

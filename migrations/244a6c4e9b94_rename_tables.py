...
def upgrade():
    ...
    sa.Column('category', gino.schema.Enum('unassigned', 'tools', 'comedy', 'tragic_comedy', 'drama', 'rom_com', 'romance', 'horror', 'mystery', 'satire', 'thriller', 'sci_fi', name='modcategory'), nullable=True),
    sa.Column('nsfw', sa.Boolean(), nullable=True),
    sa.Column('theme_color', gino.schema.Enum('default', 'red', 'pink', 'purple', 'deep_purple', 'indigo', 'blue', 'cyan', 'teal', 'green', 'lime', 'yellow', 'orange', 'deep_orange', name='modcolor'), nullable=True),
    sa.Column('released_at', sa.Date(), nullable=True),
    sa.Column('last_updated', sa.DateTime(), nullable=True),
    sa.Column('status', gino.schema.Enum('archived', 'planning', 'in_development', 'playtesting', 'released', name='modstatus'), nullable=True),
    ...
    sa.Column('type', gino.schema.Enum('github', 'gitlab', 'discord', name='connectiontype'), nullable=True),
    ...
    sa.Column('mod_id', sa.Unicode(), nullable=True),
    sa.Column('type', gino.schema.Enum('ipg_violation', 'conduct_violation', 'dmca', name='reporttype'), nullable=True),
    ...
    sa.Column('role', gino.schema.Enum('unassigned', 'owner', 'co_owner', 'programmer', 'artist', 'writer', 'musician', 'public_relations', name='authorrole'), nullable=True),
    sa.Column('user_id', sa.Unicode(), nullable=True),
    sa.Column('mod_id', sa.Unicode(), nullable=True),
    ...
    sa.Column('user_id', sa.Unicode(), nullable=True),
    sa.Column('reaction', gino.schema.Enum('upvote', 'downvote', 'funny', name='reactiontype'), nullable=False),
